...
if __name__ == "__main__":
    print("Welcome to the Course Slot Booking System \n")
    ...
    while registration_open:
        ...
        if option == 1:
            ...
            if student_roll in vit.student_list and course_code in vit.course_list:
                vit.student_list[student_roll].register_course(course_code)
            else:
            ...
            course_code = input("Enter course code: ")
            if student_roll in vit.student_list and course_code in vit.course_list:
                vit.student_list[student_roll].unregister_course(course_code)
            else:
                print("Student not found or course not found")
        elif option == 7:
